...
cat > test_optimized_crawler.js << 'JSEOF'
...
echo "✅ 测试脚本已创建: test_optimized_crawler.js"
echo ""
echo "=== 执行测试 ==="
node test_optimized_crawler.js
...
echo ""
echo "查看文本内容（前100行）:"
cat /tmp/feishu_extracted_*.txt 2>/dev/null | tail -1 | head -100
